...
function BookmarkCategoryMenu({ category, openMenuId, toggleAddBookmarkFormVisibility, toggleEditBookmarkCategoryFormVisibility, isBookmarkCategoryMarkedForDeletion, setIsBookmarkCategoryMarkedForDeletion }) {
    return (
        <ul className={`${styles.actions} ${openMenuId == category.id ? styles.open : ''}`}>
            ...
            <li key={category.id + 'edit'} className={styles.action} onClick={toggleEditBookmarkCategoryFormVisibility}>
            ...
            <li key={category.id + 'delete'} className={styles.action} onClick={setIsBookmarkCategoryMarkedForDeletion}>
